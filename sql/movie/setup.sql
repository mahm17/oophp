...
INSERT INTO `movie` (`title`, `year`, `image`) VALUES
    ('Pulp fiction', 1994, '../../htdocs/img/pulp-fiction.jpg'),
    ('American Pie', 1999, '../../htdocs/img/american-pie.jpg'),
    ('Pokémon The Movie 2000', 1999, '../../htdocs/img/pokemon.jpg'),
    ('Kopps', 2003, '../../htdocs/img/kopps.jpg'),
    ('From Dusk Till Dawn', 1996, '../../htdocs/img/from-dusk-till-dawn.jpg')
;
